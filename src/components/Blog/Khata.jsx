    ...
    <>
      ...
      <section className="blog-page-container">
        ...
        <div className="blog-page-container-right">
          {/* <Link to="/blog/must-know-legal-documents-for-property-buyers-and-sellers" className="blog-page-container-right-set">
            <div className="blog-page-container-right-set-img">
              <img src={Khata} alt="Khata" />
            </div>
            <p>Essential Real Estate Legal Documents in Bangalore, what Every Buyer & Seller Must Know</p>
          </Link>  */}
          <Link
